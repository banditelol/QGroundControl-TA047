...
//! [7]
void ScenarioDialog::createHorizontalGroupBox()
{
...
//! [8]
void ScenarioDialog::createGridGroupBox()
{
...
//! [12]
void ScenarioDialog::createFormGroupBox()
{
...
QPushButton *ScenarioDialog::createButton(const QString &text, const char *member)
{
...
//! [10]
QComboBox *ScenarioDialog::createComboBox(const QString &text)
{
...
void ScenarioDialog::assignParameter()
{
